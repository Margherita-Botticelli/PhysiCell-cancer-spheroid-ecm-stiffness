...
def plots_adh_vs_rep_spheroid_growth(data, simulation_name, save_folder):
    ...
    plt.savefig(save_folder + f'plots/adh_vs_rep_spheroid_growth_rib{ribose}_{simulation_name}.png', bbox_inches = "tight")
...
def plots_adh_vs_rep_clusters(data, simulation_name, save_folder):
    ...
    ### Set title, overlaied plots
    plt.suptitle(f'Percentage of cells in main cluster',fontsize=15, y=1.0)
    plt.title(f'Prolif rate={prolif}, max mot speed={max_mot_speed}',fontsize=12)

    plt.savefig(save_folder + f'plots/adh_vs_rep_cluster_rib{ribose}_{simulation_name}.png', bbox_inches = "tight")
