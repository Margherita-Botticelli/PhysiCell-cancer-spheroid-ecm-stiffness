...
if __name__ == '__main__':
    ...
    simulations = list(range(0,288)) # list(range(0,96)) # Example: [240], [291], list(range(0,240)), etc.
  
    #### Flag to determine if existing data should be replaced
    replacing = True
    
    #### List of ribose concentrations to test
    riboses = [0]  # Options: [0, 50, 200]
    ...
    times = [96*60] # Time points to consider for images, Options: 'all', [24*60, 48*60, 72*60, 96*60]
    video = False
    statistics = False
